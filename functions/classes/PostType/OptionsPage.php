<?php
  ...
  class OptionsPage
  {
    static protected $postTypeSlug = 'optionspage';
    ...
    {
      $labels = [
        'name'                  => __('Options pages', 'center3'),
        'singular_name'         => __('Options page', 'center3'),
        'menu_name'             => __('Options pages', 'center3'),
        'name_admin_bar'        => __('Options page', 'center3'),
        'add_new'               => __('Add new [optionspage]', 'center3'),
        'add_new_item'          => __('Add new options page', 'center3'),
        'new_item'              => __('New options page', 'center3'),
        'edit_item'             => __('Edit options page', 'center3'),
        'view_item'             => __('View options page', 'center3'),
        'all_items'             => __('All options pages', 'center3'),
        'search_items'          => __('Search options page', 'center3'),
        'parent_item_colon'     => __('Parent options page:', 'center3'),
        'not_found'             => __('No options pages.', 'center3'),
        'not_found_in_trash'    => __('No options pages in trash.', 'center3'),
        ...
        'archives'              => __('Options pages archive', 'center3'),
        ...
        'filter_items_list'     => __('Filter options pages list', 'center3'),
        'items_list_navigation' => __('Options pages list navigation', 'center3'),
        'items_list'            => __('Options pages list', 'center3'),
      ];
